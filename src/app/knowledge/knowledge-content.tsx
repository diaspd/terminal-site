		...
		<main className="flex items-center justify-start mt-5 gap-4 w-full p-4">
            ...
            Next.js, React Native, Electron, UX, UI.
				...
				<Accordion.Item className="AccordionItem" value="item-2">
					<Accordion.Trigger className="text-xl flex items-center gap-2 font-semibold mt-2 text-gray-200 hover:text-gray-500 transition-all duration-500 rounded border-2 border-gray-800 focus-visible:border-gray-500 group">
            Back-end
						<div className="group-data-[state=open]:rotate-180 hidden group-hover:flex">
							<ArrowFatLineDown className="w-4 h-4" />
						</div>
