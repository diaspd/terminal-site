		...
		<>
			...
			<main className="flex items-center justify-start max-w-fit p-4">
                ...
                Book Wise
					...
					<p className="text-xl mt-3 text-gray-200 hover:text-gray-600 transition-all duration-500 hover:translate-y-2">
						<Link target="_blank" href="https://ignite-call-diaspd.vercel.app/" className="rounded border-2 border-gray-800 focus-visible:border-gray-500">
                  Ignite Call
						</Link>
					</p>

					<p className="text-xl mt-3 text-gray-200 hover:text-gray-600 transition-all duration-500 hover:translate-y-2">
						<Link target="_blank" href="https://letmeask-88cb8.web.app/" className="rounded border-2 border-gray-800 focus-visible:border-gray-500">
                  Let Me Ask
						</Link>
					</p>
					<p className="text-xl mt-3 text-gray-200 hover:text-gray-600 transition-all duration-500 hover:translate-y-2">
						<Link
							className="rounded border-2 border-gray-800 focus-visible:border-gray-500"
							target="_blank"
